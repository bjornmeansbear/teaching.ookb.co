...
/** @ngInject */
function Controller( $scope, $window, config, companyService, requestContext, Deferred, sessionService, presentationService, shareService, screenService, conversationService, commentService, userService, projectViewingService, dateHelper, projectService, validationService, modelEvents, $timeout, _ ){
...
/** @ngInject */
function Controller( $scope, $location, requestContext, Deferred, screenService, conversationService, commentService, modelEvents, _, $timeout ){
function applyData() {
